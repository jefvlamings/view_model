# = View Model Base
#
# This class accepts an arbitrary hash and exposes the keys as class attributes
# ==== Examples
#
#   model = ViewModel::Base.new(a: 1, b: {b1: 1, b2: 2}, c: 3)
#
#   model.a   # => 1
#   model.b   # => {b1: 1, b2: 2}
#   model.c   # => 3
...
#
#   model = ViewModel::Base.new(class: "test")
#
